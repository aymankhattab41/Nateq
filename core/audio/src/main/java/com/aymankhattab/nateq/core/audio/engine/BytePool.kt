...
class BytePool(
    ...
    companion object {
        ...
        /**
         * أقصى سعة للعناصر. حدٌّ صغير يمنع تسرّب الذاكرة عندما تُرك النصوص
         * الطويلة صفائفَ ضخمة خاملةً في القائمة؛ الثمانية عناصر تكفي لتداخل
         * النطق وتتابع الإعلانات الشائعة (ساعة/إشعار+رسائل).
         */
        private const val DEFAULT_MAX_CAPACITY = 8
    }
}