    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        appScope.launch {
            ...
            try {
                ...
                // **لا ربطٍ دافئٍ مسبق هنا:** كان يُغلق الرابطَ السليمَ القائم
                // (من معاينة/دورة سابقة) ويفتح ربطاً جديداً قبيل النطق — فإذا
                // لم يكتمل في موعده صمتَّ نطقُ المتصل تاماً على الجهاز. التهيئة
                // تُرحل داخل [AnnouncementSpeaker.speak] كما في بقية المسارات.
